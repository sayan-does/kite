...
const tabs = [
  ...
  { path: '/my-stack', label: 'Stack', icon: StackIcon },
...
export default function BottomNav() {
  ...
  return (
    <nav className="kite-bottom-nav" aria-label="Main navigation">
      {tabs.map(({ path, label, icon: Icon }) => {
        ...
        return (
          <Link
            key={path}
            to={path}
            className={`kite-bottom-nav-item${active ? ' kite-bottom-nav-item-active' : ''}`}
